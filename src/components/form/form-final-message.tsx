...
interface FormFinalMessageProps {
  onReset: () => void;
}

export function FormFinalMessage({ onReset }: FormFinalMessageProps) {
        ...
        <div className="w-full max-w-2xl space-y-8">
          ...
          >
            ...
            <p className="text-muted-foreground text-base">
              ...
              , cada detalhe é analisado com responsabilidade, seguindo
              protocolos médicos e regulatórios.
            </p>
          </motion.div>
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <p className="text-left text-sm leading-relaxed text-yellow-800 dark:text-yellow-200">
                ...
                garantir a sua segurança e oferecer a melhor experiência
                possível.
              </p>
            </div>
          </motion.div>
